...
We're mutating the rating and diving it by two in order to get the rating. We then select our columns and filter by misisng variables and create parameters/filers around the variables we want to plot
